...
import app.divarinterview.android.data.source.post.PostLocalDataSource
...
class DataSourceModule {
    ...
    @Singleton
    @Named("postLocal")
    fun providePostLocalDataSource(database: DivarDatabase): PostDataSource {
        return PostLocalDataSource(database)
    }
}